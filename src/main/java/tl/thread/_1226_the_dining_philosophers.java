...
public class _1226_the_dining_philosophers {
    ...
    static class DiningPhilosophers {
        ...
        public void wantsToEat(int philosopher,
            ...
            int leftLockIndex = philosopher;
            int rightLockIndex = philosopher + 1;
            if (rightLockIndex >= semaphores.length) {
                rightLockIndex = 1;
            }

            Semaphore leftS = semaphores[leftLockIndex];
            Semaphore rights = semaphores[rightLockIndex];
            for (;;) {
                boolean lSuccess = leftS.tryAcquire();
                boolean rSuccess = rights.tryAcquire();
